...
export class StudentAttendanceListComponent implements OnInit , OnDestroy{
   ...
   getLectureEventSubscription: Subscription;
   ...
   ngOnInit(): void {
      ...
      this. getLectureEventSubscription = this.studentAttendanceServiceService.getAttendancesEvent.subscribe(value => {
         this.spin = true;
   ...
   ngOnDestroy(): void {
      this.getLectureEventSubscription.unsubscribe();
