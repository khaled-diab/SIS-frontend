export class Constants {
  public static readonly collegePageUrl = 'http://localhost:8080/api/colleges/findAll/';
  public static readonly deleteCollegeUrl = 'http://localhost:8080/api/colleges/deleteCollege/';
