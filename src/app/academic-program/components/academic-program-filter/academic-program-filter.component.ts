...
export class AcademicProgramFilterComponent implements OnInit {
   ...
   applyFilter(): void {
      // this.academicProgramService.academicProgramFilterEvent.next(this.academicProgramRequestModel);
      this.academicProgramService.academicProgramFilterEvent.next([this.searchValue, this.collegeFilter, this.departmentFilter]);
   }
   ...
   resetFilter(): void {
      ...
      this.departmentSelect.setDisabledState(true);
      this.searchValue = '';
      this.departmentFilter = this.collegeFilter = undefined;
      this.academicProgramService.academicProgramFilterEvent.next(['', undefined, undefined]);
   }
}
