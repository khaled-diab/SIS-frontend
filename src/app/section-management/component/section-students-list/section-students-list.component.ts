...
} from '../../../studentEnrollment-management/component/studentEnrollment-delete/delete-studentEnrollment.component';
...
export class SectionStudentsListComponent implements OnInit {
   ...
   private handleSuccessfulDeletion(): void {
      ...
      filter.filterSection = this.section.id;
      this.studentEnrollmentManagementService
         .searchStudentEnrollments(this.paginator.pageIndex, this.paginator.pageSize, filter).subscribe(value => {
         this.tableData = value;
      });
