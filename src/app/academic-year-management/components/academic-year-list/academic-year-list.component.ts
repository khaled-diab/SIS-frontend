...
export class AcademicYearListComponent implements OnInit, OnDestroy {
   ...
   addOrUpdateAcademicYear(academicYear: AcademicYear): void {
      if (this.isSmallScreen) {
         ...
         this.service.closeSaveEvent.subscribe(e => {
               ...
               if (e !== 'Cancel') {
                  this.snackBar.open('Academic Year Saved Successfully', undefined, {
                     duration: 4000,
                  ...
                  this.service.getAcademicYears().subscribe(data => {
                     ...
                     AcademicYearService.yearsList = data;

                  });
               }
            },
            error => {
               this.snackBar.open('Academic Year Saving Failed', undefined, {
                  duration: 4000,
   ...
   private initialDataSubscription(): Subscription {
      return this.service
         ...
         .subscribe(value => {
            ...
            this.dataSource.data = this.tableData;
            AcademicYearService.yearsList = value;
         });
   }
   ...
   private handleSuccessfulDeletion(): void {
      ...
      this.snackBar.open('Academic Year Deleted Successfully', undefined, {
         duration: 4000,
         panelClass: 'successSnackBar'
      });
   }
